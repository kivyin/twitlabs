    ...
    <div>
      ...
      <section className="panel inset-panel zero-boot-panel">
        ...
        <ul className="doc-bullets">
          ...
          <li>All tasks, projects, tags, notes, notebooks, decision picker lists, training workouts, calendar events, and shopping lists</li>
        ...
        <ul className="doc-bullets">
          ...
          <li>Out-of-box applications (Budget, Tasks, Notes, Decision Picker, Site Tracker, Training, Calendar)</li>
