...
function NoteContentEditor({
  ...
  const drawingActive = activeTool === "pen" || activeTool === "eraser";

  return (
    <div className={`note-content-editor${isFullscreen ? " note-content-editor--fullscreen" : ""}`}>
          ...
          <div className="note-content-toolbar-group note-draw-tools">
            ...
            <label className="note-draw-tool">
              ...
              <select
                ...
                aria-label={activeTool === "eraser" ? "Eraser size" : "Pen size"}
              >
                {PEN_SIZES.map((size) => (
      ...
      <div className="note-content-body">
        <RichTextEditor
          ...
          placeholder="Type here, or switch to Pen to draw on top of your note."
          overlay={
            <NoteDrawCanvas
              overlay
